      ...
      <MainContent>
        ...
        <div style={{display: 'flex'}}>
          <MainContentBody>
            ...
            <br />
            <P>Our secondary palette contains a variety of colors to keep things fresh and interesting. When used in conjunction with our primary palette, these colors make every moment feel on-brand and every interaction informative.</P>
            <br />
            <br />
            { labelsHeader }
            <Separator />
