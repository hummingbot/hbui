  ...
  return (
    <PageRoot>
      ...
      <MainContent>
        ...
        <br />
        <br />
        <img src={emotionLogo} alt='Emotion.js' style={{maxHeight: '100px'}} />
        <br />
        <P><Bold>Emotion.js</Bold> is the second most popular css-in-js library available. Our choice of Emotion.js is based on the fact that it is smaller and around 20% faster then styled-components. As of now, there are no features unique to styled-components that justify using styled-components instead of Emotion.js. We also considered using Stitches.js which is even faster, but still has a small community compared to that of Emotion.js.</P>
        <br />
        <br />
      </MainContent>
    </PageRoot>
