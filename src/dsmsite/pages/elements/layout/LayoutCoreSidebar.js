  ...
  return (
    <PageRoot>
      ...
      <MainContent>
        ...
        <br />
        <br />
        <P>The sidebar layout consists of a sidebar on the left side together with a single column layout on the right side.</P>
        <br />
        <Separator />
        <br />
        <br />
        ...
        <br />
        <P>The container where the main content will be placed. A <Red>Section</Red> and <Blue>Container</Blue> elements should be placed inside this element to ensure correct responsive behavior.</P>
        <br />
