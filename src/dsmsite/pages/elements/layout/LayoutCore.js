  ...
  return (
    <PageRoot>
      ...
      <MainContent>
        ...
        <P isBold>PageRoot</P>
        <br />
        <P>Placed at the root of a page, ensures the page always takes the full height of the browser window. A great way to ensure the correct background color fills the screen.</P>
        <br />
        <P isBold>Section</P>
        <br />
        <P>Takes the full width of the screen, and is ready to handle a <Bold>Container</Bold> inside.</P>
        <br />
        <P isBold>Container</P>
        <br />
        <P>Is the central column, within a single-column layout. <Bold>Responsive</Bold> by default.</P>
        <br />
        <br />
        <br />
        <H6>Example:</H6>
        <br />
        <P>Resize the browser to see the interplay between <Green>PageRoot</Green>, <Red>Section</Red> and <Blue>Container</Blue>:</P>
        <br />
        <P>(Note how the <Green>PageRoot</Green> takes the full screen height, the <Red>Section</Red> the full width, and the <Blue>Container</Blue> a constrained central position.)</P>
        <br />
        ...
        <P isBold>SBLRoot</P>
        <br />
        <P>Placed at the root of a sidebar layout page, handles the containment of <Bold>SBLRootSidebar</Bold> and <Bold>SBLRootContent</Bold>.</P>
        <br />
        <P isBold>SBLRootSidebar</P>
        <br />
        <P>The container for the content in the sidebar, such as navigation. This element will be hidden in small screens (mobile) and should be replaced with a mobile navigation.</P>
        <br />
        <P isBold>SBLRootContent</P>
        <br />
        <P>The container where the main content will be placed. A <Red>Section</Red> and <Blue>Container</Blue> should be placed inside this element to ensure correct responsive behavior.</P>
        <br />
        <P>Resize the browser to see the responsive behavior in action. Also, note how the layout takes the height of your browser window, and how the content area is scroolable.</P>
        <br />
...
const codeSideBarLayout = String.raw
`import { SBLRoot, SBLRootSidebar, SBLRootContent, Section, Container } from '../hb_ui/elements/layout'
import { P } from '../hb_ui/elements/typography'
