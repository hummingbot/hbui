...
const spanStyles = {}
spanStyles[true] = tw`block truncate font-medium px-4 pl-10 py-2 hover:cursor-pointer hover:bg-grey-light-scale-300 dark:(hover:bg-grey-dark-scale-300) focus:hover:bg-red`
spanStyles[false] = tw`block truncate font-normal px-4 pl-10 py-2 hover:cursor-pointer hover:bg-grey-light-scale-300 dark:(hover:bg-grey-dark-scale-300) focus:hover:bg-red`
const spanBStyles = {}
